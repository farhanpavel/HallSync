...
export function Statuscard({ className, ...props }: CardProps) {
  ...
  return (
    <Card
      className={cn(
        "w-[55%] border-[1px] border-gray-300 shadow-2xl bg-gradient-to-r from-white via-gray-50 to-gray-100 rounded-lg",
        className
      )}
      {...props}
    >
        ...
        <Card>
          ...
          <CardFooter className="py-6">
            <Button
              ...
              className="w-1/5 mx-auto bg-gradient-to-r from-blue-500 to-teal-400 text-white hover:from-blue-300 hover:to-teal-200 transition-colors duration-300"
            >
              Start
            </Button>
          </CardFooter>
        ...
        <Card>
          <CardHeader className="text-center py-6">
            ...
            <CardDescription className="text-xs text-gray-600">
              Please wait for the provost&apos;s response.
            </CardDescription>
          </CardHeader>
            ...
            <div className="text-sm font-rubik space-y-4 mt-4 text-left">
              ...
              <div className="text-gray-600 space-y-2">
                ...
                <p>
                  ...
                  {formData?.enroll_year || "N/A"}
                </p>
                <p>
                  <span className="font-semibold text-gray-800">
                    Graduation Year:{" "}
                  </span>
                  {formData?.expected_grad || "N/A"}
                </p>
                <p>
                  <span className="font-semibold text-gray-800">
                    Allocated Hall:{" "}
